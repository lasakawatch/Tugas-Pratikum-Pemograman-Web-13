...
<div class="container">
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST">
        ...
        <input type="text" name="name" value="{{ $product->name }}" placeholder="Masukkan nama produk" required>

        <label><i class="bi bi-cash me-2"></i>Harga Produk</label>
        <input type="number" name="price" value="{{ $product->price }}" placeholder="Masukkan harga" required>

        <label><i class="bi bi-box me-2"></i>Stok</label>
        <input type="number" name="stock" value="{{ $product->stock }}" placeholder="Jumlah stok" required>

        <label><i class="bi bi-shop me-2"></i>Toko</label>
        <input type="text" name="store" value="{{ $product->store }}" placeholder="Nama toko" required>

        <label><i class="bi bi-file-text me-2"></i>Deskripsi</label>
        <textarea name="description" rows="4" placeholder="Deskripsi produk" required>{{ $product->description }}</textarea>
